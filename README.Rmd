...
The goal of revise is to support authors in responding to revise and resubmit requests. These functions are designed to work with [crsj/papaja](https://github.com/crsh/papaja)
